...
To start, [add the Grafana Cloud integration](https://supabase.com/dashboard/project/_/integrations/grafana/overview) and select a project.
...
Supabase's native Grafana integration is recommended, though you can also configure and run the setup yourself by following the steps below.
...
4. Set your Project ID and enter the service account API key,Expand commentComment on line R29Resolved
