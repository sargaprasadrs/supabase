...
If you are changing log settings for Data API roles, such as `authenticator`, `anon`, ..., you will need to reload PostgREST to reflect the timeout changes by running the following script:
